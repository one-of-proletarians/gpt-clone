...
export const MessageItem = memo<MessageProps>(
  ({
    ...
    const save = () => {
      const newMessage = createChatMessage(editImage, image, textareaValue);
    ...
    return (
      <>
        {image && editImage && (
          <div className="relative mb-1 ml-auto max-w-72 overflow-hidden rounded-md border xs:max-w-[250px]">
